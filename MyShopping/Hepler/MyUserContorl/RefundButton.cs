...
{
    public partial class RefundButton : UserControl
    {
        public RefundButton()
        {
            InitializeComponent();
        ...
        static string path = @"D:\上位机正式课\MyShopping1\MyShopping\Shopping\image\减.png";
        ...
        private void RefundButton_MouseEnter(object sender, EventArgs e)
        {
            isMouseOver = true;
            this.Invalidate(); // 重新绘制控件
        }

        private void RefundButton_MouseLeave(object sender, EventArgs e)
        {
            isMouseOver = false;
            this.Invalidate(); // 重新绘制控件
        }
